...
class Beansdetailed extends StatefulWidget {
  const Beansdetailed({Key? key});

  @override
  State<Beansdetailed> createState() => _BeansdetailedState();
}

class _BeansdetailedState extends State<Beansdetailed> {
  @override
      ...
      body: SafeArea(
            ...
            children:[ 
              ...
              child: Stack(
                children: [
                   ...
                   Container(
                     child: Image.asset(
                        'assets/Images/arabica_coffee_beans/arabica_coffee_beans_portrait.png',
                        fit: BoxFit.cover,
                    ...
                    Padding(
                      ...
                      (left: 10),
                      child: IconButton(onPressed: (){}, icon: Icon(Icons.arrow_back),color: Colors.white,highlightColor: Colors.grey,),
                    ),
        ...
        //Color.fromRGBO(235, 134, 72, 1),
                                      Padding(
                                        ...
                                        left: 6),
                                        child: Column(children: [  Text('Price',style: TextStyle(color: Color.fromRGBO(235, 134, 72, 1)),),
                                                                            Text('Price',style: TextStyle(color: Color.fromRGBO(235, 134, 72, 1)),),
            ...
            borderRadius: BorderRadius.circular(10.0),
                                    ...
                                    onPressed: (){}, child: Text('Add To Cart',style: TextStyle(fontFamily: 'Regular',fontSize: 15,color: Colors.white),)),
